...
function MobileContent() {
  return (
    <>
      ...
      >
        조직의 성장과 발전을 위해 역량을 갖춘 인재를 양성하고, 함께할 동료가 있다면 무엇이든 해낼 수
        있으리라 봅니다.
      </Lead>
      <Lead
        className="appear-animation animated fadeInUpShorter appear-animation-visible line-height-4"
      ...
      >
        결국 개인과 조직의 행복은 사람에 있다는 것을 믿으며, 더와이컨설팅은 고객이 행복해지는 순간을
        연구하는 다양한 커뮤니케이션 프로그램을 연구하도록 하겠습니다.
      </Lead>
